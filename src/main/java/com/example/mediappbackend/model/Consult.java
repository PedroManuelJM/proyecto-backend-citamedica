...
public class Consult {
    ...
    @OneToMany(mappedBy = "consult" , cascade = {CascadeType.ALL} , orphanRemoval = true , fetch = FetchType.EAGER) //  , fetch = FetchType.LAZY
    // orphanRemoval -> para eliminar el detalle
    private List<ConsultDetail> details;
    // PARA ATRIBUTOS ANIDADOS
    //  FetchType.EAGER  --> dispone todos los valores de golpe , que sea información poca
    //  FetchType.LAZY
}
